...
#SBATCH --time=0-72:00:00                                   # Max time for each task hrs:min:sec
...
# Seed offset variable allows job to restart at later points in the array, in case of interrupted runs.
...
# --- Construct command ---
CMD=(python src/cnn_train_different_seeds.py
    ...
    --res_folder "${RES_FOLDER:-seed-runs-mod}"
    --runtime_env slurm
)
